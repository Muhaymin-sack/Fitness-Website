...
cur.execute("Create Table If Not Exists User_table(User_id Integer Primary Key Autoincrement, Name Text, Age Integer, Gender Text, Email Text, Password Text)")

cur.execute("Create Table If Not Exists Admin_table(Admin_id Integer Primary Key Autoincrement, Name Text, Age Integer, Gender Text, Email Text, Password Text)")

cur.execute("Create Table If Not Exists Trainer_table(Trainer_id Integer Primary Key Autoincrement, Name Text, Age Integer, Gender Text, Email Text, Password Text)")
...
cur.execute("Create Table If Not Exists Membership_table(Membership_id Integer Primary Key Autoincrement, " \
            "Tag Text, Card_Name Text, Sub_Card Text, Price Text, Description Text, Icons Text)")

cur.execute ("""INSERT INTO Membership_table (Tag, Card_Name, Sub_Card, Price, Description, Icons)
...
cur.execute("""Create Table If Not Exists products_table
            (Products_id Integer Primary Key Autoincrement, Name Text Not Null, Price Integer Not Null, Image Text Not Null)
            """)



cur.execute("""Create Table If Not Exists cart_table
            (User_id Integer Not Null, Products_id Integer Not Null, Quantities Integer Not Null,
            FOREIGN KEY(User_id) REFERENCES User_table(User_id), 
            FOREIGN KEY(Products_id) REFERENCES products_table(Products_id))
            """)


cur.execute ("""INSERT INTO products_table (Name, Price, Image)          
                VALUES 
                    ("Performance Leggings", 40, "static/images/Performance Leggins.png"),
                    ("Training Shorts", 30, "static/images/shorts.png"),
                    ("Pre-Workout Surge", 35, "static/images/preworkoutsurge.png"),
                    ("Protein Bars", 22, "static/images/Protein Bar.png"),
                    ("Pro Lifting Belt", 45, "static/images/Pro Belt.png"),
                    ("Stainless Steel Shaker", 15, "static/images/Shaker.png")
              """)
